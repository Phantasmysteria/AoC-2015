...
for person in ['Alice', 'Bob', 'Carol', 'David', 'Eric', 'Frank', 'George', 'Mallory']:
    data['02-map'][(person, 'Me')] = 0
    data['02-map'][('Me', person)] = 0

output = 0

for seating in itertools.permutations(['Alice', 'Bob', 'Carol', 'David', 'Eric', 'Frank', 'George', 'Mallory', 'Me']):
